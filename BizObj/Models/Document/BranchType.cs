...
namespace BizObj.Document
{
    public class BranchType
    {
        ...
        {
            public const string Get = "usp_BranchType_Get";
            public const string Insert = "usp_BranchType_Insert";
            public const string Update = "usp_BranchType_Update";
            public const string Delete = "usp_BranchType_Delete";
            public const string List = "usp_BranchType_List";
        }
        
        public const int ObjectTypeID = 23;
        ...
        public BranchType(string userName)
        {
            UserName = userName;
        }

        public BranchType(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public BranchType(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int branchTypeId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@BranchTypeID", SqlDbType.Int);
            prms[0].Value = branchTypeId;
