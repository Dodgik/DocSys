...
{
    public class InputSubjectType
    {
        private struct SpNames
        {
            public const string Get = "usp_InputSubjectType_Get";
            public const string Insert = "usp_InputSubjectType_Insert";
            public const string Update = "usp_InputSubjectType_Update";
            public const string Delete = "usp_InputSubjectType_Delete";
            public const string List = "usp_InputSubjectType_List";
        }

        public const int ObjectTypeID = 19;
        ...
        public InputSubjectType(string userName)
        {
            UserName = userName;
        }

        public InputSubjectType(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public InputSubjectType(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int inputSubjectTypeId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@InputSubjectTypeID", SqlDbType.Int);
            prms[0].Value = inputSubjectTypeId;
