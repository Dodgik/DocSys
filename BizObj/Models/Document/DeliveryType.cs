...
namespace BizObj.Document
{
    public class DeliveryType
    {
        ...
        {
            public const string Get = "usp_DeliveryType_Get";
            public const string Insert = "usp_DeliveryType_Insert";
            public const string Update = "usp_DeliveryType_Update";
            public const string Delete = "usp_DeliveryType_Delete";
            public const string List = "usp_DeliveryType_List";
        }
        
        public const int ObjectTypeID = 21;
        ...
        public DeliveryType(string userName)
        {
            UserName = userName;
        }

        public DeliveryType(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public DeliveryType(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int deliveryTypeId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@DeliveryTypeID", SqlDbType.Int);
            prms[0].Value = deliveryTypeId;
