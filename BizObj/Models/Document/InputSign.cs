...
namespace BizObj.Document
{
    public class InputSign
    {
        ...
        {
            public const string Get = "usp_InputSign_Get";
            public const string Insert = "usp_InputSign_Insert";
            public const string Update = "usp_InputSign_Update";
            public const string Delete = "usp_InputSign_Delete";
            public const string List = "usp_InputSign_List";
        }

        public const int ObjectTypeID = 20;
        ...
        public InputSign(string userName)
        {
            UserName = userName;
        }

        public InputSign(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public InputSign(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int inputSignId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@InputSignID", SqlDbType.Int);
            prms[0].Value = inputSignId;
