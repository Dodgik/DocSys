...
namespace BizObj.Document
{
    public class InputDocType
    {
        ...
        {
            public const string Get = "usp_InputDocType_Get";
            public const string Insert = "usp_InputDocType_Insert";
            public const string Update = "usp_InputDocType_Update";
            public const string Delete = "usp_InputDocType_Delete";
            public const string List = "usp_InputDocType_List";
        }
        
        public const int ObjectTypeID = 18;
        ...
        public InputDocType(string userName)
        {
            UserName = userName;
        }

        public InputDocType(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public InputDocType(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int inputDocTypeId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@InputDocTypeID", SqlDbType.Int);
            prms[0].Value = inputDocTypeId;
