...
namespace BizObj.Document
{
    public class SocialCategory
    {
        ...
        {
            public const string Get = "usp_SocialCategory_Get";
            public const string Insert = "usp_SocialCategory_Insert";
            public const string Update = "usp_SocialCategory_Update";
            public const string Delete = "usp_SocialCategory_Delete";
            public const string List = "usp_SocialCategory_List";
        }

        public const int ObjectTypeID = 25;
        ...
        public SocialCategory(string userName)
        {
            UserName = userName;
        }

        public SocialCategory(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public SocialCategory(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int socialCategoryId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@SocialCategoryID", SqlDbType.Int);
            prms[0].Value = socialCategoryId;
