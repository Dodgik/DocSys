...
namespace BizObj.Document
{
    public class SocialStatus
    {
        ...
        {
            public const string Get = "usp_SocialStatus_Get";
            public const string Insert = "usp_SocialStatus_Insert";
            public const string Update = "usp_SocialStatus_Update";
            public const string Delete = "usp_SocialStatus_Delete";
            public const string List = "usp_SocialStatus_List";
        }

        public const int ObjectTypeID = 9;
        ...
        public SocialStatus(string userName)
        {
            UserName = userName;
        }

        public SocialStatus(int id, string userName): this(userName)
        {
            Init(null, id);
        }

        public SocialStatus(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        }
        #endregion
        ...
        private void Init(SqlTransaction trans, int socialStatusId)
        {
            if (!CanView(UserName))
            {
            ...
            prms[0] = new SqlParameter("@SocialStatusID", SqlDbType.Int);
            prms[0].Value = socialStatusId;
        ...
        {
            return SPHelper.ExecuteReader(SpNames.List);
        }
        #endregion
