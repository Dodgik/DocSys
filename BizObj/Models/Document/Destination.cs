...
namespace BizObj.Document
{
    ...
    public class Destination
    {
        ...
        {
            public const string Get = "usp_Destination_Get";
            public const string Insert = "usp_Destination_Insert";
            public const string Update = "usp_Destination_Update";
            public const string Delete = "usp_Destination_Delete";
            public const string IsExist = "usp_Destination_IsExist";
            public const string List = "usp_Destination_List";
        }
        ...
        public Destination(int id, string userName): this(null, id, userName)
        {

        }

        public Destination(SqlTransaction trans, int id, string userName): this(userName)
        {
            Init(trans, id);
        ...
        private void Init(SqlTransaction trans, int documentId)
        {
            ...
            CreationDate = prms[5].Value != DBNull.Value ? (DateTime)prms[5].Value : DateTime.MinValue;
