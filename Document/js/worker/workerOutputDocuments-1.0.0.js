(function (window) {
    ...
    var workerOutputDocuments = function (selector, options) {
        options = options || {};
        var self = this;
        ...
        this.init = function () {
            ...
            $('#dg' + selector).jqGrid({
                ...
                colNames: ['№', 'documentID', 'Дата', '№', '№ в організації', 'Зміст', 'Зміни', 'Відмітки', 'Контроль',
                    ...
                    'questionTypeID', 'questionTypeName', 'Адресат'],
                colModel: [
                    ...
                    { name: 'destination', index: 'DestinationName', width: 360, sortable: false }
                ],
                rownumbers: true,
                rowNum: 100,
        ...
        this.showInsertForm = function () {
            var currentDocument = new OutputDocumentBlank({
        ...
        this.showUpdateForm = function () {
            ...
            if (rowId) {
                ...
                currentDocument.showUpdateForm(rowObj.id);
            }
            else
        ...
        this.showDelForm = function () {
            ...
            if (rowId) {
                ...
                currentDocument.showDeleteForm(rowObj.id, function () {
                    $('#' + self.jqGridID).trigger("reloadGrid");
                });
            }
            else
    ...
    window.WorkerOutputDocuments = workerOutputDocuments;
})(window);