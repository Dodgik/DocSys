            ...
            function createSubGrid(p) {
                ...
                function createSubCardsGrid(s) {
                    ...
                    $('#' + s.subgridTableId).jqGrid({
                        ...
                        mtype: 'POST',
                        height: '100%',
                        colNames: ['id', 'documentID', '№', 'Початок', 'Виконати до', 'Стан картки', 'Виконавець', 'Контрольна відповідь', 'Резолюція', 'Бланк', 'groupId', 'InnerNumber', 'Коментарі'],
                        colModel: [
                            ...
                            { name: 'CountDocumentComments', width: 80, sortable: false, formatter: function (cellValue, cOptions, rowObject) {
